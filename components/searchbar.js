...
export function Searchbar({placeholder}){
  ...
  return(
    <span className="flex-1 border-b hover:border dark:border-none p-2 ml-10 mr-16 rounded-lg font-bold bg-white dark:bg-gray-600 dark:hover:bg-gray-500 text-gray-400">
